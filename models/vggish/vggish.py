...
class VGGish(VGG):
    ...
    def forward(self, x, fs=None):
        ...
        # Input Shape: (Seq_len, Batch_size, Channels, H, W)
        seq_len, batch_size, ch, H, W = x.shape
        
        x = x.view(batch_size*seq_len, ch, H, W).to(self.get_device())
